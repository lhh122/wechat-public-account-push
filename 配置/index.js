export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8d3582247b5b2474",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b86f03d5c24f8782af71f73c37dc2c06",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "徐小稀", "year": "2004", "date": "03-06"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "09-15"},
  ...
  CALLBACK_TEMPLATE_ID: "OH_adctnZtaFeXrz6y1VcTyh9E5GTVaN7R3cybkkCtY",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "徐小稀", "year": "2004", "date": "03-06", isShowAge: true},
    {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "09-15"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
